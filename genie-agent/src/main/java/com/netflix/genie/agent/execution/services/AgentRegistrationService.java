...
/**
 * Register a newly started agent with the server, receiving back a unique identifier.
 *
 * @author mprimi
 * @since 4.0.0
 */
public interface AgentRegistrationService {
     ...
     * @return a unique agent execution ID
     * @throws AgentRegistrationException if registration fails
     */
    String registerAgent() throws AgentRegistrationException;
}
