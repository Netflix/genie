...
class AgentAutoConfigurationTest {
    ...
    @Test
    void taskExecutorCustomizer() {
        final AgentProperties properties = new AgentProperties();
        final ThreadPoolTaskExecutorCustomizer customizer = new AgentAutoConfiguration().taskExecutorCustomizer(properties);
    ...
    @Test
    void taskSchedulerCustomizer() {
        final AgentProperties properties = new AgentProperties();
        final ThreadPoolTaskSchedulerCustomizer customizer = new AgentAutoConfiguration().taskSchedulerCustomizer(properties);
