...
class CreateJobDirectoryStageSpec extends Specification {
    ...
    void setup() {
        ...
        this.stage = new CreateJobDirectoryStage(jobSetupService)
    }
    ...
    def "AttemptTransition -- success"() {
        ...
        1 * jobSetupService.createJobDirectory(jobSpec) >> jobDir
    ...
    def "AttemptTransition -- error"() {
        ...
        then:
        1 * executionContext.getJobSpecification() >> jobSpec
        1 * jobSetupService.createJobDirectory(jobSpec) >> { throw setupException }
        0 * executionContext.setJobDirectory(jobDir)
