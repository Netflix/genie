...
/**
 * OpenJPA based implementation of the ClusterConfigServiceOld.
 *
 * @author skrishnan
 */
public class PersistentClusterConfigImplOld implements ClusterConfigServiceOld {

    private static Logger logger = LoggerFactory
            .getLogger(PersistentClusterConfigImplOld.class);
     ...
     */
    public PersistentClusterConfigImplOld() throws CloudServiceException {
