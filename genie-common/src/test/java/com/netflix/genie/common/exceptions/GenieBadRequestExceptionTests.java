 ...
 * @author tgianos
 */
public class GenieBadRequestExceptionTests extends Exception {
    ...
    public void testTwoArgConstructor() throws GenieBadRequestException {
        final GenieBadRequestException ge = new GenieBadRequestException(ERROR_MESSAGE, IOE);
    ...
    public void testMessageArgConstructor() throws GenieBadRequestException {
        final GenieBadRequestException ge = new GenieBadRequestException(ERROR_MESSAGE);
        Assert.assertEquals(HttpURLConnection.HTTP_BAD_REQUEST, ge.getErrorCode());
        Assert.assertEquals(ERROR_MESSAGE, ge.getMessage());
