...
public class ClusterConfigResponseOld extends BaseResponse {

    private static final long serialVersionUID = -1L;

    private String message;

    private ClusterConfigElementOld[] clusterConfigs;
     ...
     */
    public ClusterConfigResponseOld(CloudServiceException error) {
        super(error);
    }
     ...
     * Default constructor.
     */
    public ClusterConfigResponseOld() {
    }
     ...
     */
    public void setClusterConfigs(ClusterConfigElementOld[] inClusterConfigs) {
