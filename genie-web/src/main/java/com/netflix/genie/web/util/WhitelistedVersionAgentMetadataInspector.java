...
/**
 * An {@link AgentFilterService.AgentMetadataInspector} that accepts agent whose version matches a regular expression
 * obtained via properties.
 * Non-whitelisted versions are allowed to proceed through the rest of the filters.
 *
 * @author mprimi
 * @since 4.0.0
 */
public class WhitelistedVersionAgentMetadataInspector extends BaseRegexAgentMetadataInspector {
    ...
    public WhitelistedVersionAgentMetadataInspector(final AgentFilterProperties agentFilterProperties) {
        super(AgentFilterService.InspectionReport.InspectionDecision.ACCEPT);
