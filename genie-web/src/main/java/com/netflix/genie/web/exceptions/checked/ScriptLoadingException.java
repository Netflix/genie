...
public class ScriptLoadingException extends GenieCheckedException {
     ...
     */
    public ScriptLoadingException(final String message) {
        super(message);
    }
     ...
     */
    public ScriptLoadingException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause The root cause of this exception
     */
    public ScriptLoadingException(final Throwable cause) {
        super(cause);
    }
}
