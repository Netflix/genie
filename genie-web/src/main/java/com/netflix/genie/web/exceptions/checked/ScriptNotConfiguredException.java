...
public class ScriptNotConfiguredException extends GenieCheckedException {
     ...
     */
    public ScriptNotConfiguredException(final String message) {
        super(message);
    }
     ...
     */
    public ScriptNotConfiguredException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause The root cause of this exception
     */
    public ScriptNotConfiguredException(final Throwable cause) {
        super(cause);
    }
}
