...
/**
 * Specifications for the {@link TasksSchedulerPoolProperties} class.
 *
 * @author tgianos
 * @since 4.0.0
 */
class TasksSchedulerPoolPropertiesSpec extends Specification {

    def "Default parameters are as expected"() {
        when:
        def properties = new TasksSchedulerPoolProperties()

        then:
        properties.getSize() == 2
        properties.getThreadNamePrefix() == "genie-task-scheduler-"
    }
