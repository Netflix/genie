...
/**
 * Common specifications for all the classes which extend {@link GenieCheckedException} within the web project.
 *
 * @author tgianos
 */
class GenieWebCheckedExceptionsSpec extends Specification {
