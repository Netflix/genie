...
def populateTestHive():
    ...
    <request>
      <hiveConfig>
        <name>testhive</name>
        <type>TEST</type>
        <s3HiveSiteXml>s3://BUCKET/PATH/TO/TEST-HIVE-SITE.XML</s3HiveSiteXml>
        <user>testuser</user>
...
def populateProdHive():
    ...
    <request>
      <hiveConfig>
        <name>prodhive</name>
        <type>PROD</type>
        <s3HiveSiteXml>s3://BUCKET/PATH/TO/PROD-HIVE-SITE.XML</s3HiveSiteXml>
        <user>testuser</user>
        <status>ACTIVE</status>
        <hiveVersion>0.8.1</hiveVersion>
      </hiveConfig>
...
def populateTestPig():
    ...
    <request>
      <pigConfig>
        <name>testpig</name>
        <type>TEST</type>
        <s3PigProperties>s3://BUCKET/PATH/TO/TEST-PIG.PROPERTIES</s3PigProperties>
        <user>testuser</user>
        <status>ACTIVE</status>
...
def populateProdPig():
    ...
    <request>
      <pigConfig>
        <name>prodpig</name>
        <type>PROD</type>
        <s3PigProperties>s3://BUCKET/PATH/TO/PROD-PIG.PROPERTIES</s3PigProperties>
        <user>testuser</user>
        <status>ACTIVE</status>
        <pigVersion>0.9.2</pigVersion>
      </pigConfig>
