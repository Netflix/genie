...
public class JobRestControllerIntegrationTests extends RestControllerIntegrationTestsBase {
    ...
    private void checkJob(final int documentationId, final String id, final List<String> commandArgs) throws Exception {
        ...
        this.mvc
            ...
            .andExpect(MockMvcResultMatchers.jsonPath(CREATED_PATH, dateFormatMatcher))
            .andExpect(MockMvcResultMatchers.jsonPath(UPDATED_PATH, dateFormatMatcher))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath(STARTED_PATH, dateFormatMatcher))
            .andExpect(MockMvcResultMatchers.jsonPath(FINISHED_PATH, dateFormatMatcher))
