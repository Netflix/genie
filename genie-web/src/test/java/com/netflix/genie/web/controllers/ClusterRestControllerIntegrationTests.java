...
public class ClusterRestControllerIntegrationTests extends RestControllerIntegrationTestsBase {
    ...
    public void canCreateClusterWithoutId() throws Exception {
        ...
        this.mvc
            ...
            .andExpect(MockMvcResultMatchers.jsonPath(ID_PATH, Matchers.notNullValue()))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath(TAGS_PATH, Matchers.hasItem(Matchers.startsWith("genie.id:"))))
