...
:snippet-base: {snippets}/job-rest-controller-integration-tests/1/getJobOutput/json
...
:snippet-base: {snippets}/job-rest-controller-integration-tests/1/getJobOutput/html
...
:snippet-base: {snippets}/job-rest-controller-integration-tests/1/getJobOutput/file
