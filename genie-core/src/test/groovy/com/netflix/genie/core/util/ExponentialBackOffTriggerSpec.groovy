...
class ExponentialBackOffTriggerSpec extends Specification {
    ...
    def "NextExecutionTime with type #delayType"(
        ...
        ExponentialBackOffTrigger.DelayType.FROM_PREVIOUS_SCHEDULING           | [101L, 102, 104, 108, 116, 116, 116]
        ExponentialBackOffTrigger.DelayType.FROM_PREVIOUS_EXECUTION_BEGIN      | [201L, 202, 204, 208, 216, 216, 216]
        ExponentialBackOffTrigger.DelayType.FROM_PREVIOUS_EXECUTION_COMPLETION | [301L, 302, 304, 308, 316, 316, 316]
    }
