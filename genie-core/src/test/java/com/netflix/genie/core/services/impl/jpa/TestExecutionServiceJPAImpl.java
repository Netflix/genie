...
public class TestExecutionServiceJPAImpl {
    ...
    private com.netflix.genie.core.repositories.jpa.JobRepository jobRepository;
    ...
    @Before
    public void setup() {
        this.jobRepository = Mockito.mock(com.netflix.genie.core.repositories.jpa.JobRepository.class);
