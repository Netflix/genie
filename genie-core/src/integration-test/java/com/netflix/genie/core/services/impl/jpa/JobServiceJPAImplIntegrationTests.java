...
public class JobServiceJPAImplIntegrationTests extends DBUnitTestBase {
    ...
    public void testAddTagsToJob() throws GenieException {
        ...
        Assert.assertEquals(3, this.service.getTagsForJob(JOB_1_ID).size());
        final Set<String> finalTags = this.service.addTagsForJob(JOB_1_ID, newTags);
    ...
    public void testRemoveAllTagsForJob() throws GenieException {
        Assert.assertEquals(3, this.service.getTagsForJob(JOB_1_ID).size());
        final Set<String> finalTags = this.service.removeAllTagsForJob(JOB_1_ID);
    ...
    public void testRemoveTagForJob() throws GenieException {
        final Set<String> tags = this.service.getTagsForJob(JOB_1_ID);
        Assert.assertEquals(3, tags.size());
        Assert.assertEquals(2, this.service.removeTagForJob(JOB_1_ID, "2.4").size());
    }
