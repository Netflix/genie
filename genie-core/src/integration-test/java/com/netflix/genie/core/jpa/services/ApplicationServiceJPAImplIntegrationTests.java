...
public class ApplicationServiceJPAImplIntegrationTests extends DBUnitTestBase {
    ...
    public void testGetApplicationsByName() {
        final List<Application> apps = this.appService.getApplications(APP_2_NAME, null, null, null, 0, 10, true, null);
        Assert.assertEquals(1, apps.size());
        Assert.assertTrue(apps.stream().allMatch(application -> application.getId().equals(APP_2_ID)));
    }
    ...
    public void testGetApplicationsByUserName() {
        final List<Application> apps
                = this.appService.getApplications(null, APP_1_USER, null, null, -1, -5000, true, null);
    ...
    public void testUpdateApplication() throws GenieException {
        ...
        final Application updateApp = new Application
                ...
                .withId(getApp.getId())
                .withCreated(getApp.getCreated())
                .withUpdated(getApp.getUpdated())
                .withDescription(getApp.getDescription())
                .withTags(tags)
                .withConfigs(getApp.getConfigs())
                .withSetupFile(getApp.getSetupFile())
    ...
    public void testUpdateCreateAndUpdate() throws GenieException {
        ...
        final Application updateApp = new Application.Builder(
