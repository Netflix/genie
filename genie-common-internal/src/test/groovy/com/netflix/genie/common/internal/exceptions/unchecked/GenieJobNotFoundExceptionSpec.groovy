...
class GenieJobNotFoundExceptionSpec extends Specification {
    ...
    def "Can construct"() {
        ...
        GenieJobNotFoundException exception

        when:
        exception = new GenieJobNotFoundException()
        ...
        when:
        exception = new GenieJobNotFoundException(message)
        ...
        when:
        exception = new GenieJobNotFoundException(message, cause)
        ...
        when:
        exception = new GenieJobNotFoundException(cause)
