...
class Application(object):
    ...
    def create_application(self, app_obj):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to create application due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to create application. ' + url_error.reason)
    ...
    def update_application(self, app_id, app_obj):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to update application due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to update application. ' + url_error.reason)
    ...
    def delete_application(self, app_id):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to delete application due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to delete application. ' + url_error.reason)
    ...
    def get_application(self, app_id):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to get application due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to get application. ' + url_error.reason)
    ...
    def get_applications(self):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to get all applications due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to get all applications. ' + url_error.reason)
