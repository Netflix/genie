...
class Command(object):
    ...
    def create_command(self, cmd_obj):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to create command due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to create command. ' + url_error.reason)
    ...
    def update_command(self, cmd_id, cmd_obj):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to update command due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to update command. ' + url_error.reason)
    ...
    def delete_command(self, cmd_id):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to delete command due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to delete command. ' + url_error.reason)
    ...
    def get_command(self, cmd_id):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to get command due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to get command. ' + url_error.reason)
    ...
    def get_commands(self):
        ...
        try:
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to get all commands due to error code: [ '
                + str(http_error.code)
                + '] because ['
                + http_error.read()
                + ']', http_error.code)
            ...
            raise genie2.exception.genie_exception.GenieException(
                'Unable to get all commands. ' + url_error.reason)
