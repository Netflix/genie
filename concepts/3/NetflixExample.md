...
In the following cluster resources you should note the `tags` applied to each
...
In this case the job was accepted by Genie for processing. Below is the actual
