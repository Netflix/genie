...
|genie.tasks.userMetrics.enabled
|Whether or not to enable publishing of user-tagged metrics ('genie.user.*')
|true

|genie.tasks.userMetrics.rate
|Interval in milliseconds between data refreshes to publish user metrics
|5000
