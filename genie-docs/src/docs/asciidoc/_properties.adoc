...
|genie.scripts.agent-launcher-selector.properties-pattern
|The regular expression that filters which properties get passed to the script.
...
|genie.scripts.cluster-selector.properties-pattern
|The regular expression that filters which properties get passed to the script.
|^cluster-selector\..*
|no
...
|genie.scripts.command-selector.properties-pattern
|The regular expression that filters which properties get passed to the script.
|^command-selector\..*
|no
