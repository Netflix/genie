...
The agent CLI can be used to launch jobs outside of the Genie cluster (e.g., on the user Laptop) while still leveraging
...
image::apijob.png[API Job, link="{imagesdir}/apijob.png"]
...
image::clijob.png[CLI Job, link="{imagesdir}/clijob.png"]
